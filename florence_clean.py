...
file_path = r"C:\Users\HP\Downloads\florence.csv"
...
df_cleaned.to_csv('Florence_cleaned.csv', index=False)

print("Cleaned data saved as 'Florence_cleaned.csv'. Columns now are:")
