...
file_path = r"C:\Users\HP\Downloads\barcelona.csv"
...
df_cleaned.to_csv('barcelona_cleaned.csv', index=False)

print(" Cleaned data saved as 'barcelona_cleaned.csv'. Columns now are:")
