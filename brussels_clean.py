...
file_path = r"C:\Users\HP\Downloads\brusselslistings.csv"
...
df_cleaned.to_csv('brussels_cleaned.csv', index=False)

print(" Cleaned data saved as 'brussels_cleaned.csv'. Columns now are:")
